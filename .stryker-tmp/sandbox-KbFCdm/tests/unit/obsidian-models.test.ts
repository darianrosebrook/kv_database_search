  ...
  describe("extractWikilinks", () => {
    it("should extract simple wikilinks", () => {
      ...
      expect(result).toEqual([
        { link: "Simple Link", position: 10, displayText: undefined },
      ]);
    });
    ...
    it("should extract wikilinks with display text", () => {
      ...
      const result = ObsidianUtils.extractWikilinks(content);
      expect(result).toEqual([
        { link: "Real Page", displayText: "Display Text", position: 10 },
      ]);
    });
    ...
    it("should extract multiple wikilinks", () => {
      ...
      const result = ObsidianUtils.extractWikilinks(content);
      expect(result).toEqual([
        { link: "Page1", position: 8, displayText: undefined },
        { link: "Page2", displayText: "Display", position: 19 },
        { link: "Page3", position: 41, displayText: undefined },
      ]);
    });
    ...
    it("should remove duplicates", () => {
      ...
      const result = ObsidianUtils.extractWikilinks(content);
      expect(result).toEqual([
        { link: "Same Page", position: 11, displayText: undefined },
        { link: "Same Page", displayText: "Again", position: 29 },
      ]);
    });
    ...
    it("should handle nested brackets", () => {
      ...
      const result = ObsidianUtils.extractWikilinks(content);
      expect(result).toEqual([
        { link: "Page with [brackets", position: 10, displayText: undefined },
        { link: "Normal", position: 38, displayText: undefined },
      ]);
    });
    ...
    it("should handle headings and blocks", () => {
      ...
      const result = ObsidianUtils.extractWikilinks(content);
      expect(result).toEqual([
        { link: "Page#Heading", position: 10, displayText: undefined },
        { link: "Page#^block", position: 30, displayText: undefined },
      ]);
    });
    ...
    it("should handle malformed wikilinks", () => {
      ...
      expect(result).toEqual([
        {
          link: "Incomplete and [[Nested [[Broken",
          position: 8,
...
Content.`;
    ...
    it("should handle missing frontmatter", () => {
      ...
      expect(result).toEqual({
        frontmatter: {},
        body: "Just content without frontmatter.",
      });
    });

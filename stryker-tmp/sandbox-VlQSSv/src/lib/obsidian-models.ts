...
export class ObsidianUtils {
  ...
  static extractWikilinks(content: string): string[] {
    if (stryMutAct_9fa48("1403")) {
      ...
      stryCov_9fa48("1403");
      const wikilinkRegex = stryMutAct_9fa48("1405") ? /\[\[([\]]+)\]\]/g : stryMutAct_9fa48("1404") ? /\[\[([^\]])\]\]/g : (stryCov_9fa48("1404", "1405"), /\[\[([^\]]+)\]\]/g);
      const links: string[] = stryMutAct_9fa48("1406") ? ["Stryker was here"] : (stryCov_9fa48("1406"), []);
      let match;
      while (stryMutAct_9fa48("1408") ? (match = wikilinkRegex.exec(content)) === null : stryMutAct_9fa48("1407") ? false : (stryCov_9fa48("1407", "1408"), (match = wikilinkRegex.exec(content)) !== null)) {
        if (stryMutAct_9fa48("1409")) {
          ...
          const target = linkContent.split(stryMutAct_9fa48("1410") ? "" : (stryCov_9fa48("1410"), '|'))[0];
          links.push(target);
        }
      }
      return stryMutAct_9fa48("1411") ? [] : (stryCov_9fa48("1411"), [...new Set(links)]);
    }
  }
  static extractTags(content: string): string[] {
    if (stryMutAct_9fa48("1412")) {
      ...
      stryCov_9fa48("1412");
      const tagRegex = stryMutAct_9fa48("1414") ? /#([^a-zA-Z0-9_-]+)/g : stryMutAct_9fa48("1413") ? /#([a-zA-Z0-9_-])/g : (stryCov_9fa48("1413", "1414"), /#([a-zA-Z0-9_-]+)/g);
      const tags: string[] = stryMutAct_9fa48("1415") ? ["Stryker was here"] : (stryCov_9fa48("1415"), []);
      let match;
      while (stryMutAct_9fa48("1417") ? (match = tagRegex.exec(content)) === null : stryMutAct_9fa48("1416") ? false : (stryCov_9fa48("1416", "1417"), (match = tagRegex.exec(content)) !== null)) {
      ...
      return stryMutAct_9fa48("1419") ? [] : (stryCov_9fa48("1419"), [...new Set(tags)]);
    }
  }
  static parseFrontmatter(content: string): Record<string, any> {
    if (stryMutAct_9fa48("1420")) {
      ...
      stryCov_9fa48("1420");
      const frontmatterRegex = stryMutAct_9fa48("1425") ? /^---\n([\s\s]*?)\n---/ : stryMutAct_9fa48("1424") ? /^---\n([\S\S]*?)\n---/ : stryMutAct_9fa48("1423") ? /^---\n([^\s\S]*?)\n---/ : stryMutAct_9fa48("1422") ? /^---\n([\s\S])\n---/ : stryMutAct_9fa48("1421") ? /---\n([\s\S]*?)\n---/ : (stryCov_9fa48("1421", "1422", "1423", "1424", "1425"), /^---\n([\s\S]*?)\n---/);
      const match = content.match(frontmatterRegex);
      if (stryMutAct_9fa48("1428") ? false : stryMutAct_9fa48("1427") ? true : stryMutAct_9fa48("1426") ? match : (stryCov_9fa48("1426", "1427", "1428"), !match)) return {};
      try {
        if (stryMutAct_9fa48("1429")) {
          ...
          const lines = match[1].split(stryMutAct_9fa48("1430") ? "" : (stryCov_9fa48("1430"), "\n"));
          for (const line of lines) {
            if (stryMutAct_9fa48("1431")) {
              {}
            } else {
              stryCov_9fa48("1431");
              const [key, ...valueParts] = line.split(stryMutAct_9fa48("1432") ? "" : (stryCov_9fa48("1432"), ":"));
              if (stryMutAct_9fa48("1435") ? key || valueParts.length > 0 : stryMutAct_9fa48("1434") ? false : stryMutAct_9fa48("1433") ? true : (stryCov_9fa48("1433", "1434", "1435"), key && (stryMutAct_9fa48("1438") ? valueParts.length <= 0 : stryMutAct_9fa48("1437") ? valueParts.length >= 0 : stryMutAct_9fa48("1436") ? true : (stryCov_9fa48("1436", "1437", "1438"), valueParts.length > 0)))) {
                if (stryMutAct_9fa48("1439")) {
                  {}
                } else {
                  stryCov_9fa48("1439");
                  const value = stryMutAct_9fa48("1440") ? valueParts.join(":") : (stryCov_9fa48("1440"), valueParts.join(stryMutAct_9fa48("1441") ? "" : (stryCov_9fa48("1441"), ":")).trim());
                  // Remove quotes if present
                  frontmatter[stryMutAct_9fa48("1442") ? key : (stryCov_9fa48("1442"), key.trim())] = value.replace(stryMutAct_9fa48("1446") ? /^["']|[^"']$/g : stryMutAct_9fa48("1445") ? /^["']|["']/g : stryMutAct_9fa48("1444") ? /^[^"']|["']$/g : stryMutAct_9fa48("1443") ? /["']|["']$/g : (stryCov_9fa48("1443", "1444", "1445", "1446"), /^["']|["']$/g), stryMutAct_9fa48("1447") ? "Stryker was here!" : (stryCov_9fa48("1447"), ""));
                }
              }
            }
          }
  ...
  static generateFileChecksum(content: string): string {
    if (stryMutAct_9fa48("1449")) {
      ...
      return crypto.createHash(stryMutAct_9fa48("1450") ? "" : (stryCov_9fa48("1450"), "sha256")).update(content).digest(stryMutAct_9fa48("1451") ? "" : (stryCov_9fa48("1451"), "hex"));
    }
  }
  static determineContentType(filePath: string, vaultPath: string, frontmatter: Record<string, any>): string {
    if (stryMutAct_9fa48("1452")) {
      ...
      if (stryMutAct_9fa48("1454") ? false : stryMutAct_9fa48("1453") ? true : (stryCov_9fa48("1453", "1454"), frontmatter.type)) {
      ...
      const relativePath = filePath.replace(vaultPath, stryMutAct_9fa48("1456") ? "Stryker was here!" : (stryCov_9fa48("1456"), "")).replace(stryMutAct_9fa48("1458") ? /^\// : stryMutAct_9fa48("1457") ? /\/+/ : (stryCov_9fa48("1457", "1458"), /^\/+/), stryMutAct_9fa48("1459") ? "Stryker was here!" : (stryCov_9fa48("1459"), ""));

      // Path-based classification
      if (stryMutAct_9fa48("1461") ? false : stryMutAct_9fa48("1460") ? true : (stryCov_9fa48("1460", "1461"), relativePath.includes(stryMutAct_9fa48("1462") ? "" : (stryCov_9fa48("1462"), "MOCs/")))) return stryMutAct_9fa48("1463") ? "" : (stryCov_9fa48("1463"), "moc");
      if (stryMutAct_9fa48("1465") ? false : stryMutAct_9fa48("1464") ? true : (stryCov_9fa48("1464", "1465"), relativePath.includes(stryMutAct_9fa48("1466") ? "" : (stryCov_9fa48("1466"), "Articles/")))) return stryMutAct_9fa48("1467") ? "" : (stryCov_9fa48("1467"), "article");
      if (stryMutAct_9fa48("1469") ? false : stryMutAct_9fa48("1468") ? true : (stryCov_9fa48("1468", "1469"), relativePath.includes(stryMutAct_9fa48("1470") ? "" : (stryCov_9fa48("1470"), "AIChats/")))) return stryMutAct_9fa48("1471") ? "" : (stryCov_9fa48("1471"), "conversation");
      if (stryMutAct_9fa48("1473") ? false : stryMutAct_9fa48("1472") ? true : (stryCov_9fa48("1472", "1473"), relativePath.includes(stryMutAct_9fa48("1474") ? "" : (stryCov_9fa48("1474"), "Books/")))) return stryMutAct_9fa48("1475") ? "" : (stryCov_9fa48("1475"), "book-note");
      if (stryMutAct_9fa48("1477") ? false : stryMutAct_9fa48("1476") ? true : (stryCov_9fa48("1476", "1477"), relativePath.includes(stryMutAct_9fa48("1478") ? "" : (stryCov_9fa48("1478"), "templates/")))) return stryMutAct_9fa48("1479") ? "" : (stryCov_9fa48("1479"), "template");
      return stryMutAct_9fa48("1480") ? "" : (stryCov_9fa48("1480"), "note");
    }
  }
}
 ...
 */
export const OBSIDIAN_CONTENT_TYPES = Object.freeze(stryMutAct_9fa48("1481") ? [] : (stryCov_9fa48("1481"), [stryMutAct_9fa48("1482") ? "" : (stryCov_9fa48("1482"), "note"), stryMutAct_9fa48("1483") ? "" : (stryCov_9fa48("1483"), "moc"), stryMutAct_9fa48("1484") ? "" : (stryCov_9fa48("1484"), "article"), stryMutAct_9fa48("1485") ? "" : (stryCov_9fa48("1485"), "conversation"), stryMutAct_9fa48("1486") ? "" : (stryCov_9fa48("1486"), "template"), stryMutAct_9fa48("1487") ? "" : (stryCov_9fa48("1487"), "book-note"), stryMutAct_9fa48("1488") ? "" : (stryCov_9fa48("1488"), "canvas"), stryMutAct_9fa48("1489") ? "" : (stryCov_9fa48("1489"), "dataview")]));

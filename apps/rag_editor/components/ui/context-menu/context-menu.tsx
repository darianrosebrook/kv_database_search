...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(styles.contextMenuSubTrigger, className)}
      {...props}
    >
      {children}
...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(styles.contextMenuItem, className)}
      {...props}
    />
  )
}
...
function ContextMenuRadioItem({
  ...
  return (
    <ContextMenuPrimitive.RadioItem
      ...
      className={cn(styles.contextMenuRadioItem, className)}
      {...props}
    >
      <span className={styles.contextMenuItemIndicator}>
        <ContextMenuPrimitive.ItemIndicator>
...
function ContextMenuLabel({
  ...
  return (
    <ContextMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(styles.contextMenuLabel, className)}
      {...props}
    />
  )
}
...
function ContextMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(styles.contextMenuShortcut, className)}
      {...props}
    />
  )
}

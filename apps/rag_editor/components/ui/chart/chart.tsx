...
function ChartTooltipContent({
  ...
  return (
    <div className={cn(styles.chartTooltip, className)}>
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  {itemConfig?.icon ? (
                    ...
                    !hideIndicator && (
                      <div
                        className={cn(styles.indicator, styles[indicator])}
                        style={
                          {
...
function ChartLegendContent({
  ...
  return (
    <div
      className={cn(
        styles.chartLegend,
        verticalAlign === "top" ? styles.top : styles.bottom,
        className
      )}
    >
      {payload.map((item) => {

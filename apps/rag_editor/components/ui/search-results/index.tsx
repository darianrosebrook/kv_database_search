...
const mockResults: SearchResult[] = [
  {
    id: "1",
    text: "Comprehensive guide to implementing vector databases for semantic search. Covers Pinecone, Weaviate, and Chroma with performance comparisons and integration examples.",
    meta: {
      contentType: "text",
      section: "Vector Database Implementation Guide",
      breadcrumbs: [],
      uri: "/Projects/Research/Vector Databases.md",
    },
    source: {
      type: "web",
      path: "/Projects/Research/Vector Databases.md",
      url: "/Projects/Research/Vector Databases.md",
    },
  ...
  {
    id: "2",
    text: "In-depth conversation about Retrieval Augmented Generation patterns, embedding strategies, and context window optimization for knowledge management systems.",
    meta: {
      contentType: "chat_session",
      section: "RAG Architecture Discussion",
      breadcrumbs: [],
      uri: "/Chat/RAG Discussion",
    },
    source: {
      type: "chat",
      path: "/Chat/RAG Discussion",
      url: "/Chat/RAG Discussion",
    },
  ...
  {
    id: "3",
    text: "Key insights on implementing effective semantic search: chunking strategies, embedding models, similarity thresholds, and result ranking algorithms.",
    meta: {
      contentType: "text",
      section: "Semantic Search Best Practices",
      breadcrumbs: [],
      uri: "/Personal/Learning/AI Search.md",
    },
    source: {
      type: "web",
      path: "/Personal/Learning/AI Search.md",
      url: "/Personal/Learning/AI Search.md",
    },
  ...
  {
    id: "4",
    text: "Step-by-step implementation of OpenAI's text-embedding-ada-002 model for document vectorization and similarity search in TypeScript applications.",
    meta: {
      contentType: "text",
      section: "OpenAI Embeddings Integration",
      breadcrumbs: [],
      uri: "/Projects/Implementation/Embeddings.md",
    },
    source: {
      type: "web",
      path: "/Projects/Implementation/Embeddings.md",
      url: "/Projects/Implementation/Embeddings.md",
    },
  ...
  {
    id: "5",
    text: "Comparative analysis of knowledge graphs and vector search approaches for information retrieval, including hybrid solutions and use case recommendations.",
    meta: {
      contentType: "text",
      section: "Knowledge Graph vs Vector Search",
      breadcrumbs: [],
      uri: "/Research/Comparisons/Search Methods.md",
    },
    source: {
      type: "web",
      path: "/Research/Comparisons/Search Methods.md",
      url: "/Research/Comparisons/Search Methods.md",
    },

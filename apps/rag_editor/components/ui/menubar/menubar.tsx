...
function MenubarItem({
  ...
  return (
    <MenubarPrimitive.Item
      ...
      className={cn(styles.menubarItem, className)}
      {...props}
    />
  )
}
...
function MenubarRadioItem({
  ...
  return (
    <MenubarPrimitive.RadioItem
      ...
      className={cn(styles.menubarRadioItem, className)}
      {...props}
    >
      <span className={styles.menubarItemIndicator}>
        <MenubarPrimitive.ItemIndicator>
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      ...
      data-inset={inset}
      className={cn(styles.menubarLabel, className)}
      {...props}
    />
  )
}
...
function MenubarShortcut({
  ...
  return (
    <span
      ...
      className={cn(styles.menubarShortcut, className)}
      {...props}
    />
  )
}
...
function MenubarSubTrigger({
  ...
  return (
    <MenubarPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(styles.menubarSubTrigger, className)}
      {...props}
    >
      {children}

...
// Tool-neutral content types live in @kv/types so other workspace packages
// (@kv/processors, future @kv/knowledge-graph, etc.) can depend on them
// without taking a dependency on @kv/database.
import { ContentType, MultiModalContentType } from "@kv/types";
import type { ContentMetadata, Dimensions } from "@kv/types";
export { ContentType, MultiModalContentType };
export type { ContentMetadata, Dimensions };
...
// MultiModalContentType is now exported from @kv/types (re-exported at top of file).
...
// ContentMetadata and Dimensions are now exported from @kv/types (re-exported at top of file).

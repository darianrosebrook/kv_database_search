...
const RelationshipTypeEnum = new GraphQLEnumType({
  ...
  values: {
    ...
    RELATED_TO: { value: RelationshipType.RELATED_TO },
    ...
    WORKS_FOR: { value: RelationshipType.WORKS_FOR },
    LOCATED_IN: { value: RelationshipType.LOCATED_IN },
    CREATED_BY: { value: RelationshipType.CREATED_BY },
    USED_BY: { value: RelationshipType.USED_BY },
    COLLABORATES_WITH: { value: RelationshipType.COLLABORATES_WITH },
    COMPETES_WITH: { value: RelationshipType.COMPETES_WITH },
    INFLUENCES: { value: RelationshipType.INFLUENCES },
    OTHER: { value: RelationshipType.OTHER },
  },
});

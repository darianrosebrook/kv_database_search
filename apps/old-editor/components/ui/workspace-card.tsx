  ...
  return (
    ...
    >
      <div className="space-y-2">
        <Title className="group-hover:text-foreground transition-colors">{title}</Title>
        {description && <Body className="text-muted-foreground line-clamp-2">{description}</Body>}

  ...
  try {
    ...
    switch (command) {
      ...
      default:
        console.log("Usage:");
        console.log(
          "  tsx apps/tools/caws/migrations.ts generate  # Generate migration script"
        );
        console.log(
          "  tsx apps/tools/caws/migrations.ts list      # List available migrations"
        );
        console.log(
          "  tsx apps/tools/caws/migrations.ts validate  # Validate migration order"
        );
    }
  } catch (error) {

...
import { ObsidianEmbeddingService, EmbeddingModel } from "../../src/lib/embeddings.js";
...
describe("ObsidianEmbeddingService", () => {
  ...
  describe("constructor", () => {
    ...
    it("should handle unknown model gracefully", () => {
      ...
      const serviceWithUnknown = new ObsidianEmbeddingService(configWithUnknown);
  ...
  describe("embed", () => {
    ...
    it("should handle ollama errors", async () => {
      ...
      await expect(service.embed("test text")).rejects.toThrow("Embedding failed");
    });
    ...
    it("should handle empty embeddings response", async () => {
      ...
      await expect(service.embed("test text")).rejects.toThrow("No embeddings returned from Ollama");
    });
    ...
    it("should validate embedding dimension", async () => {
      ...
      await expect(service.embed("test text")).rejects.toThrow("Embedding dimension mismatch");
    });
  });
  ...
  describe("embedWithStrategy", () => {
    ...
    it("should fail if all models fail", async () => {
      ...
      await expect(service.embedWithStrategy("test text")).rejects.toThrow("All embedding models failed");
    });
  });
  ...
  describe("selectModelForContent", () => {
    ...
    it("should select model based on domain hint", () => {
      const selected = (service as any).selectModelForContent(undefined, "knowledge-base");
      expect(selected.name).toBe("embeddinggemma");
    });
  ...
  describe("calculateEmbeddingConfidence", () => {
    it("should calculate confidence based on embedding properties", () => {
      ...
      const confidence = (service as any).calculateEmbeddingConfidence(embedding, "test text");
    ...
    it("should boost confidence for Obsidian content", () => {
      ...
      const regularConfidence = (service as any).calculateEmbeddingConfidence(embedding, "regular text");
      const obsidianConfidence = (service as any).calculateEmbeddingConfidence(embedding, "text with [[wikilinks]] and #tags");
